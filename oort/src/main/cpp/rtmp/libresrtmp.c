 ...
 */
 JNIEXPORT jlong JNICALL Java_com_yaooort_oort_SrsRtmp_open
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_com_yaooort_oort_SrsRtmp_read
 ...
 * Signature: ([CI)I
 */
 JNIEXPORT jint JNICALL Java_com_yaooort_oort_SrsRtmp_write
 ...
 * Signature: ()I
 */
 JNIEXPORT jint JNICALL Java_com_yaooort_oort_SrsRtmp_close
...
JNIEXPORT jstring JNICALL Java_com_yaooort_oort_SrsRtmp_getIpAddr
