...
package com.yaooort.coremedia.iso.boxes.mdat;

import com.yaooort.coremedia.iso.BoxParser;
import com.yaooort.coremedia.iso.ChannelHelper;
import com.yaooort.coremedia.iso.boxes.Box;
import com.yaooort.coremedia.iso.boxes.ContainerBox;
import com.yaooort.googlecode.mp4parser.AbstractBox;
 ...
 * by the metadata (see {@link com.yaooort.coremedia.iso.boxes.SampleTableBox}).<br>
 ...
 * metadata refers to media data by its absolute offset within the file (see {@link com.yaooort.coremedia.iso.boxes.StaticChunkOffsetBox});
