...
import static com.yaooort.oort.RtmpListener.MSG_RTMP_AUDIO_STREAMING;
import static com.yaooort.oort.RtmpListener.MSG_RTMP_CONNECTED;
import static com.yaooort.oort.RtmpListener.MSG_RTMP_CONNECTING;
import static com.yaooort.oort.RtmpListener.MSG_RTMP_DISCONNECTED;
import static com.yaooort.oort.RtmpListener.MSG_RTMP_NET_ERROR;
import static com.yaooort.oort.RtmpListener.MSG_RTMP_STOPPED;
...
public class SrsFlvMuxer {
    ...
    private void sendFlvTag(SrsFlvFrame frame) {
        ...
        if (frame.isVideo()) {
            ...
            wtRtmp = SrsRtmp.write(jniRtmpPointer, frame.flvTag.array(), frame.flvTag.size(), FLV_RTMP_PACKET_TYPE_AUDIO, frame.dts);
    ...
    private void disconnect() {
        try {
            if (jniRtmpPointer != 0) {
               int close = SrsRtmp.close(jniRtmpPointer);
            }
